...
Pipeline gồm 3 tác vụ chính bạn cần "viết cho nó hiểu":

| Tác vụ | Nó cần gì từ bạn |
|---|---|
| **Storyboard Plan** | Mỗi đoạn văn = 1 panel (1 góc máy, 1 chủ thể). Xuống dòng = chuyển panel. |
...
### Quy tắc 3: Một hành động = một panel

Mỗi panel chỉ là **một bức ảnh tĩnh**. Không nhồi nhiều hành động hoặc nhiều nhân vật hành động cùng lúc vào một đoạn.
...
Ngắt panel = xuống dòng + 1 dòng trống.

### Quy tắc 4: Chuyển cảnh = dòng trống kép

Hết một cảnh (đổi bối cảnh hoặc thời gian), để 1 dòng trống:
...
- [ ] Mỗi hành động = một đoạn = một panel (không nhồi nhét)
- [ ] Ngắt panel/cảnh bằng dòng trống
