...
export const POST = apiHandler(async (
  ...
  const { episodeId, content, speaker, matchedPanelId, isNarration } = body
...
export const PATCH = apiHandler(async (
  ...
  if (lineId) {
    ...
    if (isNarration !== undefined) updateData.isNarration = isNarration
