...
export function useVideoPanelActions({
  ...
  // Lip sync only for character dialogue, not narrator voice-over
  const showLipSyncSection = voiceManager.hasCharacterVoiceLines
  const canLipSync = hasVisibleBaseVideo && voiceManager.hasCharacterAudio && !taskStatus.isLipSyncTaskRunning
