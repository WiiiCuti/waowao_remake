                        ...
                        return (
                            ...
                            >
                                <div className="min-w-0">
                                    <div className="text-sm font-semibold text-[var(--glass-text-primary)] truncate flex items-center gap-1">
                                        {speaker === 'Narrator' ? <><AppIcon name="bookOpen" className="w-3.5 h-3.5 text-purple-400" /><span className="text-purple-400">旁白 (Narrator)</span></> : speaker}
                                    </div>
                ...
                {speakers.map(speaker => {
                    ...
                    return (
                        <div key={speaker} className="w-full sm:w-[280px] max-w-full flex items-center gap-1.5 px-3 py-2 rounded-xl border border-[var(--glass-stroke-base)] bg-[var(--glass-bg-surface-strong)]">
                            <div className="min-w-0">
                                <div className="font-semibold text-[var(--glass-text-primary)] truncate flex items-center gap-1" title={speaker}>
                                    {speaker === 'Narrator' ? <><AppIcon name="bookOpen" className="w-4 h-4 text-purple-400" /><span className="text-purple-400">旁白 (Narrator)</span></> : speaker}
                                </div>
