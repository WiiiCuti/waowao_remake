...
interface UseVoiceLineCrudActionsParams {
  ...
  createVoiceLineMutation: MutationLike<{ episodeId: string; content: string; speaker: string; isNarration?: boolean; matchedPanelId: string | null }, { voiceLine: VoiceLine }>
  updateVoiceLineMutation: MutationLike<{ lineId: string; content?: string; speaker?: string; isNarration?: boolean; matchedPanelId?: string | null; audioUrl?: string | null; emotionPrompt?: string | null; emotionStrength?: number }, { voiceLine: VoiceLine }>
