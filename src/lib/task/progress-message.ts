...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.MERGE_VIDEO]: 'progress.taskType.mergeVideo',
...
const STAGE_LABELS: Record<string, string> = {
  ...
  merge_start: 'progress.stage.mergeStart',
  downloading: 'progress.stage.downloading',
  merge_panel: 'progress.stage.mergePanel',
  concat: 'progress.stage.concat',
  uploading: 'progress.stage.uploading',
